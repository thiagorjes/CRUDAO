...
public class EventoBoardPublisher {
  ...
  /**
   * Chamado a partir de {@code afterCommit} da transação de negócio (ver {@code TarefaService}) — a
   * mutação já foi persistida quando este método roda. Uma falha aqui não desfaz a operação de
