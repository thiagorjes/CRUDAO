...
- [ ] TASK-04.2 — RBAC por projeto: retrabalho do modelo e enforcement _(nova, PRD v1.3, BDR-001)_
- [ ] TASK-01.3 — Configuração de projeto (toggles) e finalização _(nova)_
- [ ] TASK-02.3 — Regras avançadas de tarefa: edição travada, atribuição, finalização e auditoria _(nova)_
- [ ] TASK-05.3 — Frontend: Painel de Administração _(retrabalhada — interrompida na implementação original, gap de RBAC por projeto)_
