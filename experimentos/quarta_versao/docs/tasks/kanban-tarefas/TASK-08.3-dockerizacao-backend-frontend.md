...
**Status: Pendente** — atualizada em 2026-08-27
...
- [ ] Revisar/corrigir `docker-compose.yml` (`systems/CRUDAO/`) — os serviços `backend`/`frontend` seguem a TechSpec v1.2; nesta task:
...
- [ ] Atualizar `docs/techspec/kanban-tarefas/quickstart.md`/`README.md` se algum detalhe real (nome de env var, porta, comportamento) divergir do que a TechSpec v1.2 já documentou.
