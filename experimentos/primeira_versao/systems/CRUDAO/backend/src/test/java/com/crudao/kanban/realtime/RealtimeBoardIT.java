 ...
 * pg_notify (disparado pelo {@link TarefaService}) e valida que múltiplos clientes STOMP conectados
 * (simulando observadores em pods diferentes) recebem a atualização em até 2s.
 */
@Testcontainers
